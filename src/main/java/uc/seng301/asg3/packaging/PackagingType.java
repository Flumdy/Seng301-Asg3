...
public enum PackagingType {
  ...
  public static boolean isHollowEggPackaging(PackagingType packagingType) {
    return packagingType.equals(PackagingType.REGULAR_HOLLOW_EGG)
        || packagingType.equals(PackagingType.REGULAR_BOX);
  }

  /**
   * Helper method for determining class of packaging.
   *
   * @param packagingType
   * @return true if packaging type is regular
   */
  public static boolean isRegularEggPackaging(PackagingType packagingType){
    return packagingType.equals(PackagingType.REGULAR_HOLLOW_EGG)
